        ...
        var q = document.getElementById('quantity_'+$id2).value;
          ...
          $.ajax({
             ...
             success: function (data) {
                  ...
                  document.getElementById("total").innerHTML = "Общая сумма: "+ total + " KZT";
  ...
  <nav class="navbar sticky-top navbar-expand-lg navbar-light white scrolling-navbar">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarContent">
              ...
              <tr id="row_{{$product->id}}" >
                <th>
                  ...
                  <div id="img-card" class="view rounded">
                    <a href="/product/{{$product->id}}" class="image_st"> <img  src="{{asset('batman.jpg')}}" class = "card-img-top"alt="Lacoste" alt="" style="width: 150px; height: 150px;">   

                  </div>
                  </th>
                <th>

                 <a href="/product/{{$product->id}}" class="name_st"> <p style="font-size: 20px;font-family: 'Montserrat', sans-serif;">{{$product->name}}</p> </a>
        ...
        <hr>
  <div class="container">
    <h5 id="total" style="text-align: right;">Общая сумма: {{$total}} KZT</h5>

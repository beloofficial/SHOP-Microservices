    ...
    <div class="container dark-grey-text mt-5">
      <div class="row wow fadeInUpBig">
        <div class="col-md-6 mb-4 ">
          <img src="{{asset('batman.jpg')}}" alt="" class="img-fluid">
        </div>
        <div class="p-5 col-md-6">
          ...
          <div>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sit modi corrupti, nihil iusto praesentium rerum veniam hic suscipit accusantium, mollitia adipisci porro quos, ad nulla quidem maxime doloremque iste molestiae.</p>
          </div>

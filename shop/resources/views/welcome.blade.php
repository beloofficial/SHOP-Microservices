      ...
      <div class="collapse navbar-collapse" id="navbarContent">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            @if (!Session::has('login_token'))
                <li class="nav-item">
                    <a class="nav-link" href="/login1">{{ __('Login') }}</a>
                </li>
            @else
                <li class="nav-item dropdown">
                    <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                        {{ Session::get('login_email') }} <span class="caret"></span>
                    </a>
  ...
  <main>
    <div class="container">
       ...
       mdb-color lighten-3 mt-3 mb-5">
        ...
        <div class="collapse navbar-collapse" id="nextNav">
          ...
          <ul class="navbar-nav mr-auto">
            @if($catName == "all")
                <li class="nav-item active">      
                  <a href="/main/all" class="nav-link">Все</a>
                </li>
            @else
                <li class="nav-item">
                        <a href="/main/all" class="nav-link">Все</a>
            ...
            @endif   
                    ...
                    @foreach($categories as $k=>$category)
                      @if($catName == $category->data->id)
                        <li class="nav-item active">
                          
                          <a href="/main/{{$category->data->id}}" class="nav-link">{{$category->data->name}}</a>
                      </li>
                      @else
                      <li class="nav-item">
          ...
          <div class="col-lg-3 col-md-6 mb-4">
            ...
            <div class="card">
              ...
              <div class="view overlay">
                <!--Картинка товара-->
                <div id="img-card">
                  <img class="card-img-top" style="height: 270px"  src="{{asset('batman.jpg')}}" alt="Lacoste">
              ...
              <div class="card-body text-center">
                ...
                <h5>
                  <strong>
                    <a href="" class="dark-grey-text">{{$product->data->name}}</a>
                  </strong>
                </h5>
                <!-- Цена Товара -->
                <h4 class="font-weight-bold blue-text">
                  <strong>{{$product->data->price}} KZT</strong>
                </h4>
              </div>
            </div>
          </div>
      ...
      <nav class="d-flex justify-content-center wow fadeIn">
          ...
          @endphp
          <a href="{{url()->current()}}?page={{$prev}}" class="btn btn-outline-dark">Previous</a>
          <a href="{{url()->current()}}?page={{$next}}" class="btn btn-outline-dark">Next</a>
